...
document.addEventListener('DOMContentLoaded', async () => {
    console.log('[INIT] Starting VK TED - EU Tenders Monitor...');

    // Show loading
    showNotification('Loading real TED (Tenders Electronic Daily) data...', 'info');
    ...
    if (liveDocuments.length === 0) {
        ...
        liveDocuments = [
            { date: '2024-10-15', country: 'FI', countryName: 'Finland', type: 'tender', typeName: 'TED Tender', topic: 'supplies', topicName: 'Supplies & Services', title: 'Finland: IT Infrastructure Services - €500K', compliance: 'published', sector: 'technology', source: 'TED', sourceUrl: 'https://ted.europa.eu/', sourceBadge: 'blue', value: 500000, indicator: 'TED-2024-FI-001' },
            { date: '2024-10-14', country: 'DE', countryName: 'Germany', type: 'tender', typeName: 'TED Tender', topic: 'construction', topicName: 'Construction & Works', title: 'Germany: Rail Infrastructure Project - €15M', compliance: 'published', sector: 'infrastructure', source: 'TED', sourceUrl: 'https://ted.europa.eu/', sourceBadge: 'blue', value: 15000000, indicator: 'TED-2024-DE-002' },
            { date: '2024-10-13', country: 'NL', countryName: 'Netherlands', type: 'tender', typeName: 'TED Tender', topic: 'supplies', topicName: 'Supplies & Services', title: 'Netherlands: Health IT Systems - €2.5M', compliance: 'published', sector: 'health', source: 'TED', sourceUrl: 'https://ted.europa.eu/', sourceBadge: 'blue', value: 2500000, indicator: 'TED-2024-NL-003' },
            { date: '2024-10-12', country: 'FR', countryName: 'France', type: 'tender', typeName: 'TED Tender', topic: 'transport', topicName: 'Transport & Logistics', title: 'France: Urban Mobility Solutions - €8M', compliance: 'published', sector: 'transport', source: 'TED', sourceUrl: 'https://ted.europa.eu/', sourceBadge: 'blue', value: 8000000, indicator: 'TED-2024-FR-004' },
            { date: '2024-10-11', country: 'SE', countryName: 'Sweden', type: 'tender', typeName: 'TED Tender', topic: 'energy', topicName: 'Energy & Environment', title: 'Sweden: Renewable Energy Infrastructure - €12M', compliance: 'published', sector: 'energy', source: 'TED', sourceUrl: 'https://ted.europa.eu/', sourceBadge: 'blue', value: 12000000, indicator: 'TED-2024-SE-005' },
        ];
    }
