...
window.addEventListener("load", () => {
  ...
  calcSavings();
  // Prime inline boxes
  document.getElementById("optInline").textContent = "Tap Get recommendation to generate AI schedule.";
  document.getElementById("compInline").textContent = "Tap Get report to classify logs against EU AI Act.";
  document.getElementById("outageInline").textContent = "Tap Trigger outage drill to verify resilience + audit log.";
});
